...
function SemilleroCeaf() {
  ...
  return (
    <>
        ...
        >
        <CardOfertas
            imagebg={'/assets/images/5th_ofertas.png'}
            text={"Semillero CEAF"}
            title={
              "Buscamos estudiantes que conozcan datos de la Diáspora Africana."
            }
        ...
        >
        <CardOfertas
            imagebg={'/assets/images/8th_ofertas.png'}
            text={"Semillero CEAF"}
            title={
              "Monitoría para estudiantes de la facultad de Diseño y Humanidades."
            }
        ...
        <span
          onClick={() => {
          enviarParametros(
            '/assets/images/11th_ofertas.png'
        ...
        >
        <CardOfertas
            imagebg={'/assets/images/11th_ofertas.png'}
            text={"Semillero CEAF"}
            title={
              "Nueva convocatoria de la Beca Icesos"
            }
